...
My research focuses on developing advanced control and estimation algorithms for aerial systems, considering operational <strong> safety </strong>, <strong> security </strong>, and <strong> optimality </strong> in adversarial environments.
