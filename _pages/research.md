...
<hr>  
<div id="dots" style="display:inline"> This research aims to enhance safety and security of the operation of Multi-Agent Systems (MASs) through control theoretical approaches. </div>
